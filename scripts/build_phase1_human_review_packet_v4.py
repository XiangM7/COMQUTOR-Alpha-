#!/usr/bin/env python3
"""Build the Provider-zero Phase 1 human-review packet v4 (markdown-formatting-fidelity fix)."""
...
from comqutor_alpha.evaluation.phase1_human_review_packet_v4 import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(exc.detail)
        print("HUMAN_REVIEW_PACKET_V4_READY=NO")
        print("PROVIDER_CALLS=0")
        return 2

    coverage = verification["coverage"]
    outputs = verification["outputs"]
    print("HUMAN_REVIEW_PACKET_V4_READY=YES")
    print(f"REPORTS_INCLUDED={coverage['total_reports']}")
    print(f"ACCEPTED_REPORTS={coverage.get('accepted_reports')}")
    print(f"REJECTED_REPORTS={coverage.get('rejected_reports')}")
    ...
    print("SEMANTIC_QUALITY=UNPROVEN_V4")
    print("HUMAN_REVIEW=PENDING_V4")
    return 0
